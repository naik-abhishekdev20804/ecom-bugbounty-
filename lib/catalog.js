/** Server-side catalog (source of truth for prices). Not shipped in the browser bundle. */
...
export const PRODUCTS = [
  ...
  { id: 2, name: 'Hyderabadi Chicken Dum Biryani', cat: 'indian', image: 'https://images.unsplash.com/photo-1589302168068-964664d93dc0' + IMG_QS, price: 1499, orig: 1899, rating: 4.0, rev: 876, badge: 'hot' },
  { id: 3, name: 'Butter Chicken & Garlic Naan', cat: 'indian', image: 'https://images.unsplash.com/photo-1565557623262-b51c2513a641' + IMG_QS, price: 1399, orig: 1699, rating: 2.7, rev: 534, badge: 'new' },
  ...
  { id: 11, name: 'Grilled Paneer Tikka', cat: 'indian', image: 'https://images.unsplash.com/photo-1666001120694-3ebe8fd207be' + IMG_QS, price: 949, orig: 1199, rating: 3.5, rev: 287, badge: null },
  { id: 12, name: 'Chocolate Lava Cake', cat: 'desserts', image: 'https://images.unsplash.com/photo-1605807646983-377bc5a76493' + IMG_QS, price: 499, orig: 649, rating: 2.3, rev: 893, badge: 'new' },
];
...
const BY_ID = new Map([...PRODUCTS, ...DEALS].map((p) => [p.id, p]));
